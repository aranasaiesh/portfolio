...
export default function About() {
  return (
    <>
      <div className="flex bg-white text-black justify-center font-bold text-2xl pt-8 pl-8">
        <h1>MY PROJECTS</h1>
      </div>
      <p className="flex justify-center font-thin pt-4 pl-8">
